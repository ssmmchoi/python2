...
'''
 ...
 4   species            150 non-null    category   >> R의 factor형
'''
...
sn.pairplot(iris_df, hue="species")  # 변수와 변수 간 산점도 매트릭스
...
'''    
print(diabetes.target_names) # None : target 연속형이라는 뜻. target name이 존재하면 이 변수는 범주형.(category)
